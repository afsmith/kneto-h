...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HomePageContact'
        db.create_table(u'hotel_homepagecontact', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('form_name', self.gf('django.db.models.fields.CharField')(default='NUL', max_length=100)),
        ...
        db.send_create_signal(u'hotel', ['HomePageContact'])


    def backwards(self, orm):
        # Deleting model 'HomePageContact'
        db.delete_table(u'hotel_homepagecontact')

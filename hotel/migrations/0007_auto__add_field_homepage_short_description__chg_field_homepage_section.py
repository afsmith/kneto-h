...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HomePage.section1'
        db.alter_column(u'hotel_homepage', 'section1', self.gf('mezzanine.core.fields.RichTextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'HomePage.section1'
        db.alter_column(u'hotel_homepage', 'section1', self.gf('django.db.models.fields.TextField')(max_length=2000))

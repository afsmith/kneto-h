...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HomePage.lefttop_line2'
        db.add_column(u'hotel_homepage', 'lefttop_line2',
                      self.gf('django.db.models.fields.CharField')(default='line2', max_length=50),
                      keep_default=False)

        # Adding field 'HomePage.lefttop_line3'
        db.add_column(u'hotel_homepage', 'lefttop_line3',
                      self.gf('django.db.models.fields.CharField')(default='line3', max_length=50),
                      keep_default=False)

        # Adding field 'HomePage.lefttop_line4'
        db.add_column(u'hotel_homepage', 'lefttop_line4',
                      self.gf('django.db.models.fields.CharField')(default='line4', max_length=50),
                      keep_default=False)

        # Adding field 'HomePage.lefttop_line5'
        db.add_column(u'hotel_homepage', 'lefttop_line5',
                      self.gf('django.db.models.fields.CharField')(default='line5', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HomePage.lefttop_line2'
        db.delete_column(u'hotel_homepage', 'lefttop_line2')

        # Deleting field 'HomePage.lefttop_line3'
        db.delete_column(u'hotel_homepage', 'lefttop_line3')

        # Deleting field 'HomePage.lefttop_line4'
        db.delete_column(u'hotel_homepage', 'lefttop_line4')

        # Deleting field 'HomePage.lefttop_line5'
        db.delete_column(u'hotel_homepage', 'lefttop_line5')
